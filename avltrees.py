...
class GatorDelivery:
    ...
    def createOrder( self, order_id, current_system_time, order_value, delivery_time):
        ...
        if len(list) == 1:
            ...
            prev_order = None
            if new_index < delivering_order_index:
                if new_index + 1 == delivering_order_index:
                    if new_index + 2 == len(list):
                        prev_order = self.delivering_order
                    else:
                        prev_order = list[new_index + 2]
                else :
                    prev_order = list[new_index + 1]
            elif new_index > delivering_order_index:
            ...
            prev_order = list[new_index + 1]
            order.eta = prev_order.eta + prev_order.delivery_time + order.delivery_time
            ...
            for i in range(new_index - 1, 0, -1):    
                ...
                if i - 1 == delivering_order_index and i - 2 > -1:
                    prev_order = list[i - 2]
